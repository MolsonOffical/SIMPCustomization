    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "file",
                    models.FileField(upload_to=shoes.models.review_media_upload_path),
                ),
                (
                    "media_type",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "thumbnail",
                    models.ImageField(
                        blank=True, null=True, upload_to="shoes/thumbnails/"
                    ),
                ),
                (
                    "customizer_id",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "shoes_photo",
                    models.ImageField(blank=True, null=True, upload_to="shoes/images/"),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                (
                    "color",
        ...
        migrations.CreateModel(
            ...
            options={
                "indexes": [
                    models.Index(
                        fields=["shoe", "created_at"],
                        name="shoes_shoev_shoe_id_ac1bee_idx",
                    ),
                    models.Index(
                        fields=["user", "created_at"],
                        name="shoes_shoev_user_id_d21f49_idx",
                    ),
                    models.Index(
                        fields=["visitor_id", "created_at"],
                        name="shoes_shoev_visitor_fe2dc0_idx",
                    ),
                ],
            },
        ),
